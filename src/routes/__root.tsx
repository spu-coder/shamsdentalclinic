...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "عيادة شمس السنية التخصصية — د. ياسر شمس الدين" },
      {
        name: "description",
        content:
          "عيادة أسنان تخصصية في عين منين: جراحة، تقويم، معالجات لبية ولثوية وتجميل، مع حجز مواعيد إلكتروني.",
      },
      { name: "author", content: "عيادة شمس السنية التخصصية" },
      { property: "og:title", content: "عيادة شمس السنية التخصصية" },
      { property: "og:description", content: "د. ياسر زكريا شمس الدين — عين منين، طريق حلبون." },
